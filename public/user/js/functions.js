    ...
    darkMode: function () {
        ...
        if (e.isVariableDefined(dark)) {
            ...
            dms.addEventListener("click", function(){
              if(dir == 'rtl') {
                  if (style.getAttribute('href') == 'user/css/style-rtl.css') {
                      style.setAttribute('href', 'user/css/style-dark-rtl.css');
                  }
                  else {
                      style.setAttribute('href', 'user/css/style-rtl.css');
                  }
                }
                else {
                    if (style.getAttribute('href') == 'user/css/style.css') {
                        style.setAttribute('href', 'user/css/style-dark.css');
                    }
                    else {
                        style.setAttribute('href', 'user/css/style.css');
                    }
                }
